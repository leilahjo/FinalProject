...
namespace EngineCore
{
    ...
    BehaviorId& Entity::behaviorId() { return entityLocation.archetype->behaviorId[entityLocation.entityIndex]; }
    ...
    bool Entity::hasBehavior() { return entityLocation.archetype->hasBehavior(); }
